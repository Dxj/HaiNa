...
<div class="container">
  <div class="header"><div class="logo"><a href="?"><img src="" alt="在此处插入徽标" name="Insert_logo" height="90" id="Insert_logo" style="background-color: #8090AB; display:block;" /></a></div> <div class="seacher" align="center" ><form action="" method="get"><input name="seacher" width="480" height="32" type="text" />
    <input name="" type="submit"/></form></div>
    <!-- end .header --></div>
  <div class="sidebar1">
  <input name="" type="button" value="新增词条" />
<?php
