...
<form id="showlink" name="showlink" method="post" action="#">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="center"><input id="wnames" name="wnames{$linkarr[link_id].id}" type="text" class="txt" value="{$linkarr[link_id].name}" /></td>
    <td align="center" valign="middle" class="center"><input id="wurl" name="wurl{$linkarr[link_id].id}" type="text" class="langtxt" value="{$linkarr[link_id].url}" /></td>
